...
language_data = {
    "english": {
        "description": """
        ### 🎥 **Translate videos easily with VideoTranslate!** 📽️

        Upload a video, audio file or provide a YouTube link. 📽️ 
        ...
        # 🧩 **VideoTranslate supports different TTS (Text-to-Speech) engines, which are:**
    ...
    "spanish": {
        "description": """
        ### 🎥 **¡Traduce videos fácilmente con KenjiTranslate!** 📽️

        Sube un video, audio o proporciona un enlace de YouTube. 📽️ 
        ...
        # 🧩 **KenjiTranslate admite diferentes motores de TTS (Texto a Voz), los cuales son:**
    ...
    "french": {
        "description": """
        ### 🎥 **Traduisez facilement les vidéos avec KenjiTranslate !** 📽️
        ...
        # 🧩 **KenjiTranslate prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
    ...
    "german": {
        "description": """
        ### 🎥 **Übersetzen Sie Videos einfach mit KenjiTranslate!** 📽️
        ...
        # 🧩 **KenjiTranslate unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
    ...
    "italian": {
        "description": """
        ### 🎥 **Traduci i video facilmente con KenjiTranslate!** 📽️

        Carica un video, un file audio o fornisci un link YouTube. 📽️
        ...
        # 🧩 **KenjiTranslate supporta diversi motori TTS (Text-to-Speech), tra cui:**
    ...
    "japanese": {
        "description": """
        ### 🎥 **KenjiTranslateで簡単に動画を翻訳しましょう！** 📽️

        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ 
        ...
        # 🧩 **KenjiTranslateはさまざまなTTS（テキスト読み上げ）エンジンをサポートしています。これらは次のとおりです:**
    ...
    "chinese_zh_cn": {
        "description": """
          ### 🎥 **使用KenjiTranslate轻松翻译视频！** 📽️

          上传视频、音频文件或提供YouTube链接。 📽️ 
        ...
        "tutorial": """
          ...
          # 🧩 **KenjiTranslate支持不同的TTS（文本到语音）引擎，包括:**
    ...
    "marathi": {
        "description": """
        ### 🎥 **आसानीसोबत KenjiTranslate द्वारे व्हिडिओ अनुवाद करा!** 📽️
        ...
        # 🧩 **KenjiTranslate विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
